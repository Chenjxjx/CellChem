...
def _save_config_file(model_checkpoints_folder):
    if not os.path.exists(model_checkpoints_folder):
        ...
        shutil.copy('./CellChem_wo.yaml', os.path.join(model_checkpoints_folder, 'CellChem_wo.yaml'))
...
class SmilesnCmap(object):
    ...
    def train(self):
        ...
        model_checkpoints_folder = './Model_CellChem_wo_random_save/' #(e.g. Model_CellChem_wo_random_save,Model_CellChem_wo_scaffold_save)
...
def main():
    config = yaml.load(open("CellChem_wo.yaml", "r"), Loader=yaml.FullLoader)
    print(config)
