...
hyperparameter_defaults = dict(
    ...
    adata_path="/lustre3/lhlai_pkuhpc/zhujt/projects/smilesncmap/scGPT/examples/save/dev_clue-May21-17-14/output_adata.h5ad",
    mask_ratio=0.,
    epochs=100,
    n_bins=51,
...
for batch, batch_data in enumerate(loader):
    ...
    with torch.no_grad(), torch.cuda.amp.autocast(enabled=config.amp):
        ...
        mol_embedding, _ = model(graphs.x, graphs.batch, 
            graphs.edge_index, graphs.edge_attr,
            graphs.get('chem_desc', None))
