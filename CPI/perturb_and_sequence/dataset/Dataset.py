...
class MoleculeDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        return Protein,Mol,label,Protein_len, Mol_len
...
class MoleculeDatasetWrapper(object):
    def __init__(self, batch_size, num_workers, data_path, data_path_1):
    ...
    def get_dataset(self):
        dataset = MoleculeDataset(data_path=self.data_path,data_path_1=self.data_path_1)
